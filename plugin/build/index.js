  ...
  func handleCoreSpotlightSearchResult(_ userActivity: NSUserActivity) -> Bool {
    ...
    return true
        ...
        if (userActivityMethodRegex.test(appDelegateContent)) {
            ...
            config.modResults.contents = appDelegateContent.replace(userActivityMethodRegex, `func application(_ application: UIApplication, continue userActivity: NSUserActivity, restorationHandler: @escaping ([UIUserActivityRestoring]?) -> Void) -> Bool {
